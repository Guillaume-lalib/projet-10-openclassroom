  ...
  return <>
    ...
    <main>
      ...
      <section className="ServicesContainer" id="nos-services">
        ...
        <div className="ListContainer">
          <ServiceCard imageSrc="/images/priscilla-du-preez-Q7wGvnbuwj0-unsplash1.avif">
          ...
          <ServiceCard imageSrc="/images/hall-expo.avif">
            <h3>Conférences</h3>
          ...
          <ServiceCard imageSrc="/images/sophia-sideri-LFXMtUuAKK8-unsplash1.avif">
      ...
      <section className="PeoplesContainer" id="notre-equipe">
        ...
        <div className="ListContainer">
          <PeopleCard
            imageSrc="/images/stephanie-liverani-Zz5LQe-VSMY-unsplash.avif"
            name="Samira"
            position="CEO"
          />
          <PeopleCard
            imageSrc="/images/linkedin-sales-solutions-pAtA8xe_iVM-unsplash.avif"
            name="Jean-baptiste"
            position="Directeur marketing"
          />
          <PeopleCard
            imageSrc="/images/christina-wocintechchat-com-SJvDxw0azqw-unsplash.avif"
            name="Alice"
            position="CXO"
          />
          <PeopleCard
            imageSrc="/images/jonas-kakaroto-KIPqvvTOC1s-unsplash.avif"
            name="Luís"
            position="Animateur"
          />
          <PeopleCard
            imageSrc="/images/amy-hirschi-b3AYk8HKCl0-unsplash1.avif"
            name="Christine"
            position="VP animation"
          />
          <PeopleCard
            imageSrc="/images/christina-wocintechchat-com-0Zx1bDv5BNY-unsplash.avif"
            name="Isabelle"
    ...
    <footer className="row">
      <div className="col presta">
        ...
        <EventCard
          imageSrc={lasted?.cover}
          title={lasted?.title}
          date={new Date(lasted?.date)}
          small
          label="boom"
        />
      </div>
